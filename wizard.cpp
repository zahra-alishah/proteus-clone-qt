...
wizard::wizard(QWidget *parent) : QDialog(parent), ui(new Ui::wizard)
{
    ui->setupUi(this);
    ...
    connect(ui -> pushButton_brwoes, &QPushButton::clicked, this, [=](){
        QString dir = QFileDialog::getExistingDirectory(this, "Select Project Directory", ui -> lineEdit_path -> text());
